...
extension M1Compiler2 : CompilerUtilities {
...
class M1Compiler2 {
    ...
    func compile(findex fix: RefFun, into mem: CpuOpBuffer) throws
    {
        ...
        guard compilable.address.address == nil else {
            throw GlobalError.invalidOperation("Can not compile function (findex=\(fix)) because it already has been compiled. \(compilable.address)")
        }
