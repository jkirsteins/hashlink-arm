...
def lookup__floating_point_data_processing__2_source(val)
    ...
    matches = {
        ...
        ["0 0 00 0011"] => ["FSUB (scalar) — single-precision -", "https://developer.arm.com/documentation/ddi0596/2020-12/SIMD-FP-Instructions/FSUB--scalar---Floating-point-Subtract--scalar--?lang=en"],
        ...
        ["0 0 01 0011"] => ["FSUB (scalar) — double-precision -", "https://developer.arm.com/documentation/ddi0596/2020-12/SIMD-FP-Instructions/FSUB--scalar---Floating-point-Subtract--scalar--?lang=en"],
        ...
        ["0 0 11 0011"] => ["FSUB (scalar) — half-precision FEAT_FP16", "https://developer.arm.com/documentation/ddi0596/2020-12/SIMD-FP-Instructions/FSUB--scalar---Floating-point-Subtract--scalar--?lang=en"],
...
puts lookup(from_objd("00 c0 65 1e"))
